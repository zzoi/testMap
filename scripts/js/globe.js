ORBITAL.Globe = function($container, opts) {
    ...
    self.hslList = [
       ...
       // _.clone(new THREE.Color("#4BAD00").getHSL()),
        ...
        _.clone(new THREE.Color("#CCCCCC").getHSL())
    ];
    ...
    var distance = 100000;
    var distanceTarget = 1500;
    var maxDistanceTarget = 3000;
    var padding = 40;
    ...
    self.zoom = function(delta) {
        ...
        distanceTarget = distanceTarget > maxDistanceTarget ? maxDistanceTarget : distanceTarget;
